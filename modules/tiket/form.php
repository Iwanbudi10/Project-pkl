           ...
           <div class="box-body">
            ...
            $id_user=$_SESSION['id_user'];
             ...
             $query = mysqli_query($mysqli, "SELECT * FROM user a where a.id_user='$id_user'")
              ...
              $query_id = mysqli_query($mysqli, "SELECT RIGHT(idtiket,4) as kode FROM tiket
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="client" autocomplete="off" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <textarea row="2" class="form-control" name="problem" autocomplete="off" required></textarea>
                </div>
              </div>
			   ...
			   <div class="form-group">
                ...
                <div class="col-sm-5">
                  <textarea row="2" class="form-control" name="action" autocomplete="off" required></textarea>
                </div>
              </div>
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-5">
                  <textarea row="2" class="form-control" name="hasil" autocomplete="off" required></textarea>
                </div>
              </div>
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="date" class="form-control" name="startdate" autocomplete="off" required></textarea>
                </div>
              </div>
                ...
                <div class="col-sm-5">
                  <input type="date" class="form-control" name="enddate" autocomplete="off" required></textarea>
                </div>
              </div>
              ...
              <div class="col-sm-5">
              <input type="time" class="form-control" name="starttime" autocomplete="off" required></textarea>
              </div>
              </div>
              ...
              <div class="col-sm-5">
              <input type="time" class="form-control" name="endtime" autocomplete="off" required></textarea>
              </div>
              </div>
          ...
          <form role="form" class="form-horizontal" action="modules/tiket/proses.php?act=update" method="POST" enctype="multipart/form-data" />
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label">Client</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="client" autocomplete="off" value="<?php echo $data['client']; ?>" readonly>
                </div>
              </div>
              ...
              <label class="col-sm-2 control-label">End Date</label>
              <div class="col-sm-5">
              <input type="date" class="form-control" name="enddate" autocomplete="off" value="<?php echo $data['enddate']; ?>" required>
			  </div>
              </div>
			 ...
			 <div class="form-group">
              <label class="col-sm-2 control-label">End Time</label>
              <div class="col-sm-5">
              <input type="time" class="form-control" name="endtime" autocomplete="off" value="<?php echo $data['endtime']; ?>" required>
              </div>
              </div>
                ...
                <label class="col-sm-2 control-label">Action</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="action" autocomplete="off" value="<?php echo $data['action']; ?>"  required>
                </div>
              </div>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label">Hasil</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="hasil" autocomplete="off" value="<?php echo $data['hasil']; ?>"  required>
                </div>
              </div>
...
<?php
      ...
      elseif ($_GET['form']=='hapus') { 
		...
		$del = mysqli_query($mysqli, "DELETE FROM tiket where idtiket='$_GET[id]'") or die(mysqli_error($mysqli));
		if($del){
		
			echo '<script>alert("Berhasil menghapus data."); document.location="main.php?module=tiket";</script>';
		}else{
			echo '<script>alert("Gagal menghapus data."); document.location="main.php?module=tiket";</script>';
		}
	}else{
		echo '<script>alert("ID tidak ditemukan di database."); document.location="main.php?module=tiket";</script>';
	}
}else{
	echo '<script>alert("ID tidak ditemukan di database."); document.location="main.php?module=tiket";</script>';
}
