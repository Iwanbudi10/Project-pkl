    ...
    if ($_GET['act']=='insert') {
        if (isset($_POST['simpan'])) {
            // ambil data hasil submit dari form
			 ...
			 $startdate              = mysqli_real_escape_string($mysqli, trim($_POST['startdate']));
			 $enddate                = mysqli_real_escape_string($mysqli, trim($_POST['enddate']));
            ...
            if (empty($nama_file)) {
                ...
                $query = mysqli_query($mysqli, "INSERT INTO tiket(idtiket,client,nama,email,priority,problem,action,id_user,updateuser,date,startdate,enddate,starttime,endtime,hasil) 
                                            VALUES('$idtiket','$client','$nama','$email','$prio','$problem','$action','$id_user','$id_user','$tanggal','$startdate','$enddate','$starttime','$endtime','$hasil')")
                ...
                if(in_array($extension, $allowed_extensions)) {
                    ...
                    if($ukuran_file <= 1000000) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 1MB
                        ...
                        if(move_uploaded_file($tmp_file, $path)) { // Cek apakah gambar berhasil diupload atau tidak
                            ...
                            // perintah query untuk menyimpan data ke tabel view_kamar
                           $query = mysqli_query($mysqli, "INSERT INTO tiket(idtiket,client,nama,email,problem,action,id_user,updateuser,attachment,date,startdate,enddate,starttime,endtime,hasil) 
                                            VALUES('$idtiket','$client','$nama','$email','$problem','$action','$id_user','$id_user','$nama_file','$tanggal','$startdate','$enddate','$starttime','$endtime','$hasil')")
                                                            or die('Ada kesalahan pada query insert : '.mysqli_error($mysqli));  
