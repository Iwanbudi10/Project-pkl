                            	...
                            	<tr>
									...
									<td width="70" class="center">
										...
										<?php
											...
											<a data-rel="tooltip" data-placement="top" title="Aktifkan" style="margin-right:5px" class="green tooltip-success" href="modules/user/proses.php?act=on&id=<?php echo $data['id_user'];?>">
